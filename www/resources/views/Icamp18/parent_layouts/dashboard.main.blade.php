...
<html lang="en" >
	<head>
		...
		<link href="assets/vendors/vendors.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body class="m-page--wide m-header--fixed m-header--fixed-mobile m-footer--push m-aside--offcanvas-default"  >
						...
						<div class="m-stack__item m-brand">
							<div class="m-stack m-stack--ver m-stack--general m-stack--inline">
								<div class="m-stack__item m-stack__item--middle m-brand__logo">
									...
									<img alt="logo" align="left" style="width: 180px; height: 50px;" src="assets/img/logo.png"/>	
									</a> 
								</div>
							...
							<div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-topbar__nav-wrapper">
									<ul class="m-topbar__nav m-nav m-nav--inline">
										...
										<img src="assets/img/user-placeholder.png" class="m--img-rounded m--marginless m--img-centered" alt=""/>
										</span>
										</a>
										<div class="m-dropdown__wrapper">
										<span class="m-dropdown__arrow m-dropdown__arrow--right m-dropdown__arrow--adjust"></span>
										<div class="m-dropdown__inner">
										<div class="m-dropdown__header m--align-center" style="background: url(assets/misc/user_profile_bg.jpg); background-size: cover;">
										<div class="m-card-user m-card-user--skin-dark">
										<div class="m-card-user__pic">
										<img src="assets/img/user-placeholder.png" class="m--img-rounded m--marginless" alt=""/>
										</div>
								...
								<div id="m_header_menu" class="m-header-menu m-aside-header-menu-mobile m-aside-header-menu-mobile--offcanvas  m-header-menu--skin-dark m-header-menu--submenu-skin-light m-aside-header-menu-mobile--skin-light m-aside-header-menu-mobile--submenu-skin-light "  >
									<ul class="m-menu__nav  m-menu__nav--submenu-arrow ">
										<li class="m-menu__item {{ Request::is('/') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="{{route('dash')}}" class="m-menu__link ">
										...
										<li class="m-menu__item{{ Request::is('events') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
											<a  href="schedule" class="m-menu__link ">
											<span class="m-menu__item-here"></span>
											<span class="m-menu__link-text">
											Event Schedule
											</span>
										...
										<li class="m-menu__item{{ Request::is('payments') ? ' m-menu__item--active' : '' }}"  aria-haspopup="true">
		...
		<script src="assets/vendors/vendors.bundle.js" type="text/javascript"></script>
		<script src="assets/js/scripts.bundle.js" type="text/javascript"></script>
		<script src="assets/vendors/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
