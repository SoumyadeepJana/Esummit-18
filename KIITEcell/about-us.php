...
$pageid = "About";
$title = 'About Us - Ecell | KIIT University';
			...
			<div class="col-md-12">
				...
				<ul class="history">
					<li class="appear-animation" data-appear-animation="fadeInUp">
						<div class="thumb">
							<img src="https://ecell.org.in/assets/images/aa.jpg" alt="" />
						</div>
						<div class="featured-box">
							<div class="box-content">
								<h5 class="heading-primary">
									<strong>Achyuta Samanta |
										Founder, KIIT & KISS
									</strong>
								</h5>
								<p><strong>Achyuta Samanta</strong>, after obtaining Master’s Degree in Chemistry in 1987 from Utkal University, started his career at 22 years of age. He has 30 years of teaching experience to his credit so far. </p>
								</div>
							</div>
						</li>
					<li class="appear-animation" data-appear-animation="fadeInUp">
